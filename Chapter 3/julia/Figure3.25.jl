...
function main()
	t, x, y, vx, vy = euler(0.2, 0., cos(45*π/180), sin(45*π/180), 0.01, 50.0, 0.01)
	t2, x2, y2, vx2, vy2 = euler(0.2 + 1e-5, 0.0, cos(45*π/180), sin(45*π/180), 0.01, 50.0, 0.01)

	dif = [ sqrt((x[i] - x2[i])^2 + (y[i] - y2[i])^2) for i = 1:length(x)]
	
	semilogy(t, dif, ".", markersize = 2)
	...
	title("Stadium with α = 0.01 - divergence of two trajectories")
	savefig("Figure3.25.pdf", bbox_inches = "tight")
