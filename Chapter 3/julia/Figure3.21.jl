...
function main()
	t, x, y, vx, vy = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 140.0)
	...
	savefig("Figure3.21left.pdf", bbox_inches = "tight")
	
	t, x, y, vx, vy = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 1000.0)
	...
	savefig("Figure3.21right.pdf", bbox_inches = "tight")
