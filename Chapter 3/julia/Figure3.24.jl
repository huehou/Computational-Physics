...
function main()
	t, x, y, vx, vy = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 1000.0, 0.001)
	t2, x2, y2, vx2, vy2 = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 1000.0, 0.1)
	...
	title("Stadium billiard: \$\\alpha = 0.001\$")
	savefig("Figure3.24left.pdf", bbox_inches = "tight")
	...
	xticks([i for i = -1:0.5:1])
	yticks([i for i = -1:0.5:1])
	title("Stadium billiard: \$\\alpha = 0.1\$")
	savefig("Figure3.24right.pdf", bbox_inches = "tight")
end
