...
function main()
	t1, theta1 = euler(theta0, omega0, dt, 50., 0.5)
	t2, theta2 = euler(theta0 + 0.001, omega0, dt, 50., 0.5)
	...
	annotate("\$\\Delta \\theta\$ versus time \t \$F_D\$ = 0.5", xy = (11, 5e-4), fontsize = 14)
	savefig("Figure3.7left.pdf", bbox_inches = "tight")
end
