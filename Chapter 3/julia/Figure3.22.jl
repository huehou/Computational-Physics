...
function main()
	t, x, y, vx, vy = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 60.0, 0.0)
	t2, x2, y2, vx2, vy2 = euler(0.2, 0., cos(23*π/180), sin(23*π/180), 0.01, 60.0, 0.01)
	xb, yb = boundary(0.0)
	xb2, yb2 = boundary(0.01)
	...
	savefig("Figure3.22left.pdf", bbox_inches = "tight")
	
	figure()
	plot(x2, y2, ".", markersize = 2)
	plot(xb2, yb2)
	tick_params(direction = "in", right = true, top = true)
	xlabel("x")
	ylabel("y")
	...
	savefig("Figure3.22right.pdf", bbox_inches = "tight")
end
